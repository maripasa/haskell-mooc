...
totalPrice (MkShoppingEntry _ value count) = value * fromIntegral count
...
buyOneMore (MkShoppingEntry name value count) = MkShoppingEntry name value (count + 1)
