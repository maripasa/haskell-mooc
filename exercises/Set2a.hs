...
-- this also works, but it is great to point out you can invert
-- addEithers (Right a) (Right b) = Right (a + b)
-- addEithers (Left a) _ = Left a
-- addEithers _ (Left b) = Left b
-- The solution, which i think is minimal using this type of pattern
-- matching is:
-- addEithers :: Either String Int -> Either String Int -> Either String Int
-- addEithers (Right a) (Right b) = Right (a+b)
...
-- addEithers _          b = b
--
-- which looks alfully funny, but it's great, it's minimal, although
-- I doubt the readability
